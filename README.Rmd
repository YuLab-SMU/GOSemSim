...
[![releaseVersion](https://img.shields.io/badge/release%20version-`r rvcheck::check_bioc("GOSemSim")$latest_version`-green.svg?style=flat)](https://bioconductor.org/packages/GOSemSim)
[![develVersion](https://img.shields.io/badge/devel%20version-`r rvcheck:::get_devel_version("GuangchuangYu/GOSemSim")`-green.svg?style=flat)](https://github.com/GuangchuangYu/GOSemSim)
...
[![download](http://www.bioconductor.org/shields/downloads/GOSemSim.svg)](https://bioconductor.org/packages/stats/bioc/GOSemSim/)
[![total](https://img.shields.io/badge/downloads-`r sum(dlstats::bioc_stats("GOSemSim")$Nb_of_downloads)`/total-blue.svg?style=flat)](https://bioconductor.org/packages/stats/bioc/GOSemSim/)
