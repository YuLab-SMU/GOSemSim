...
[![releaseVersion](https://img.shields.io/badge/release%20version-`r check_bioc("GOSemSim")$latest_version`-green.svg?style=flat)](https://bioconductor.org/packages/GOSemSim)
[![develVersion](https://img.shields.io/badge/devel%20version-`r get_devel_version("GuangchuangYu/GOSemSim")`-green.svg?style=flat)](https://github.com/GuangchuangYu/GOSemSim)
...
[![citation](https://img.shields.io/badge/cited%20by-`r sum(get_article_cite_history('DO5oG40AAAAJ', 'tuHXwOkdijsC')$cites)`-green.svg?style=flat)](https://scholar.google.com.hk/scholar?hl=en&as_sdt=0,5&sciodt=0,5&cites=9484177541993722322,17633835198940746971,18126401808149291947&scipsc=)
...
[![citation](https://img.shields.io/badge/cited%20by-`r sum(get_article_cite_history('DO5oG40AAAAJ', 'tuHXwOkdijsC')$cites)`-blue.svg?style=flat)](https://scholar.google.com.hk/scholar?hl=en&as_sdt=0,5&sciodt=0,5&cites=9484177541993722322,17633835198940746971,18126401808149291947&scipsc=)
...
[![download](http://www.bioconductor.org/shields/downloads/GOSemSim.svg)](https://bioconductor.org/packages/stats/bioc/GOSemSim/)
[![total](https://img.shields.io/badge/downloads-`r sum(bioc_stats("GOSemSim")$Nb_of_downloads)`/total-blue.svg?style=flat)](https://bioconductor.org/packages/stats/bioc/GOSemSim/)
[![month](https://img.shields.io/badge/downloads-`r x <- bioc_stats("GOSemSim"); x$Nb_of_downloads[nrow(x)-1]`/month-blue.svg?style=flat)](https://bioconductor.org/packages/stats/bioc/GOSemSim/)

```{r echo=F, comment=NA}
x <- bioc_stats("GOSemSim")
