...
\newcommand{\GOIdentifiers}{\Rclass{GOIdentifiers}}
\newcommand{\GeneIdentifiers}{\Rclass{GeneIdentifiers}}
...
@
Function \textit{sim} was designed to measuring semantic similarity among \GOIdentifiers{}, \GeneIdentifiers{} and \GeneClusterSet{}.
<<sim>>=
sim(gos,params)
