...
title: 'GOSemSim: GO semantic similarity measurement'
type: index
weight: 1
---
...
<i class="fa fa-hand-o-right"></i> Find out more on <i class="fa fa-pencil"></i> [Featured Articles](https://guangchuangyu.github.io/GOSemSim/featured-articles/).
