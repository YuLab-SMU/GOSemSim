...
If you use `r Biocpkg("GOSemSim")` in published research, please cite G. Yu (2010). 
...
geneSim("241", "251", godata=hsGO, measure="Jiang", combine="BMA")
...
mgeneSim(genes, godata=hsGO2, measure="Wang", combine="BMA")
```
