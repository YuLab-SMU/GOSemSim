...
\begin{itemize}
  ...
  \item \Biocannopkg{org.Ce.eg.db}      for \textit{Celegans}
...
\begin{itemize}
    ...
    \item \href{http://ygc.name/2015/05/04/using-gosemsim-to-rank-proteins-obtained-by-co-ip/}{using GOSemSim to rank proteins obtained by co-IP}
\end{itemize}
